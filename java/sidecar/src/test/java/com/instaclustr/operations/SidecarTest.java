...
public class SidecarTest {
    ...
    void testOperationsService() throws InterruptedException {
        ...
        final Collection<Operation> allOperations = operationsResource.getOperations(ImmutableSet.of());
        ...
        final Collection<Operation> allOperationsAfterFinish = operationsResource.getOperations(ImmutableSet.of());
